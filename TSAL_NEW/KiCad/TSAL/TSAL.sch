...
U 1 1 5E46437E
P 7075 5050
F 0 "U3" H 7075 5665 50  0000 C CNN
F 1 "LDB-350L" H 7075 5574 50  0000 C CNN
...
U 1 1 5E474422
P 6375 4800
F 0 "#PWR0105" H 6375 4650 50  0001 C CNN
F 1 "+12V" H 6390 4973 50  0000 C CNN
...
U 1 1 5E475E47
P 6375 5250
F 0 "#PWR0106" H 6375 5100 50  0001 C CNN
F 1 "+24V" H 6390 5423 50  0000 C CNN
F 2 "" H 6375 5250 50  0001 C CNN
...
U 1 1 5E47775B
P 7825 4800
F 0 "#PWR0107" H 7825 4550 50  0001 C CNN
F 1 "GND" H 7830 4627 50  0000 C CNN
...
U 1 1 5E478C78
P 7825 5250
F 0 "#PWR0108" H 7825 5000 50  0001 C CNN
F 1 "GND" H 7830 5077 50  0000 C CNN
...
U 1 1 5E49F346
P 9900 2800
F 0 "J3" H 9818 2475 50  0000 C CNN
F 1 "Conn_01x02" H 9818 2566 50  0000 C CNN
...
U 1 1 5E4A0447
P 9900 3200
F 0 "J4" H 9818 2875 50  0000 C CNN
F 1 "Conn_01x02" H 9818 2966 50  0000 C CNN
...
U 1 1 5E4A0D7D
P 9900 3600
F 0 "J5" H 9818 3275 50  0000 C CNN
F 1 "Conn_01x02" H 9818 3366 50  0000 C CNN
...
U 1 1 5E4B8F56
P 10500 2750
F 0 "#PWR0110" H 10500 2500 50  0001 C CNN
...
Wire Wire Line
	9075 2025 8825 2025
Text Label 9075 650  3    50   ~ 0
LED_RED+
Text Notes 6825 4300 0    50   ~ 0
Boost Converter\n12V --> 24V
...
U 1 1 5E59B30C
P 3600 1775
F 0 "R?" H 3668 1821 50  0000 L CNN
...
U 1 1 5E59B9EC
P 3600 2075
F 0 "R?" H 3668 2121 50  0000 L CNN
...
U 1 1 5E336A58
P 3600 2225
F 0 "#PWR?" H 3600 1975 50  0001 C CNN
...
U 1 1 5E357048
P 9900 1825
F 0 "J?" H 9818 1500 50  0000 C CNN
F 1 "Conn_01x02" H 9818 1591 50  0000 C CNN
...
GLV+
Wire Wire Line
	10375 1725 10100 1725
$Comp
L power:GND #PWR?
U 1 1 5E3655EE
P 10375 1825
F 0 "#PWR?" H 10375 1575 50  0001 C CNN
F 1 "GND" H 10380 1652 50  0000 C CNN
F 2 "" H 10375 1825 50  0001 C CNN
F 3 "" H 10375 1825 50  0001 C CNN
	1    10375 1825
	1    0    0    -1  
$EndComp
Wire Wire Line
	10375 1825 10100 1825
...
U 1 1 5E35D9D3
P 9450 4950
F 0 "Q?" H 9654 4996 50  0000 L CNN
F 1 "BSS84" H 9654 4905 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 9650 4875 50  0001 L CIN
F 3 "http://assets.nexperia.com/documents/data-sheet/BSS84.pdf" H 9450 4950 50  0001 L CNN
	1    9450 4950
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E39457C
P 9000 4950
F 0 "R?" V 9207 4950 50  0000 C CNN
F 1 "R" V 9116 4950 50  0000 C CNN
...
Wire Notes Line width 31
	900  4300 900  1000
Text Notes 9000 4200 0    47   ~ 0
GREEN is on when GLV+ is present\noff when 12V (from optoisolator) is present
$Comp
L Device:R R?
U 1 1 5E42A503
P 9075 1225
F 0 "R?" H 9145 1271 50  0000 L CNN
F 1 "R" H 9145 1180 50  0000 L CNN
F 2 "" V 9005 1225 50  0001 C CNN
